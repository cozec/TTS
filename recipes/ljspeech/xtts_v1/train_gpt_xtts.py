...
required_transformers_version = "4.33.0"  # or whichever version is compatible with your XTTS
current_transformers_version = pkg_resources.get_distribution("transformers").version
if pkg_resources.parse_version(current_transformers_version) < pkg_resources.parse_version(required_transformers_version):
    raise ImportError(f"Please upgrade transformers to version {required_transformers_version} or higher. Current version: {current_transformers_version}")
...
# Alternative approach - less secure but may be necessary
...
def main():
    ...
    # Add dvae_sample_rate as an attribute after creation
    setattr(audio_config, 'dvae_sample_rate', 22050)
